...
def inject_notifications():
    if "user_id" in session:
        try: return {"notifications": get_user_notifications(session["user_id"], limit=20), "unread_count": get_unread_count(session["user_id"])}
        except Exception as e: print("inject_notifications failed:", e)
